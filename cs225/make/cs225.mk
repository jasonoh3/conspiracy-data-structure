...
$(OBJS_DIR):
	...
	@mkdir -p $(OBJS_DIR)/src/graph
	@mkdir -p $(OBJS_DIR)/src/algorithms/dfs
	@mkdir -p $(OBJS_DIR)/src/algorithms/dijkstra
	@mkdir -p $(OBJS_DIR)/src/algorithms/stronglyConnected
